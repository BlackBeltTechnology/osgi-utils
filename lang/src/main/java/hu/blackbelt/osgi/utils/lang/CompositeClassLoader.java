...
public class CompositeClassLoader extends ClassLoader {
    ...
    public void insert(@Nonnull ClassLoader classLoader) {
        checkNotNull(classLoader, MANDATORY_CLASS_LOADER_MESSAGE);
        throw new UnsupportedOperationException();
    }

    public void append(@Nonnull ClassLoader classLoader) {
        checkNotNull(classLoader, MANDATORY_CLASS_LOADER_MESSAGE);
        classLoaders.addIfAbsent(classLoader);
    }

    public void remove(@Nonnull ClassLoader classLoader) {
        checkNotNull(classLoader, MANDATORY_CLASS_LOADER_MESSAGE);
